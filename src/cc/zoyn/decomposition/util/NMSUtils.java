...
import cc.zoyn.decomposition.util.reflect.ReflectionUtils;
...
import static cc.zoyn.decomposition.util.reflect.ReflectionUtils.*;
...
public final class NMSUtils {
    ...
    public static Object getNMSItem(ItemStack itemStack) {
        ...
        try {
            return asNMSCopyMethod.invoke(itemStack, itemStack);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
