package cc.zoyn.decomposition.util;
        ...
        try {
            ...
            for (int i = 0; i < items.length; i++) {
                ...
                if (localCraftItemStack != null) {
                    ...
                    nmsItem.getClass().getMethod("save", NMSUtils.getNMSClass("NBTTagCompound")).invoke(nmsItem, localNBTTagCompound);
                }
                localNBTTagList.getClass().getMethod("add", NMSUtils.getNMSClass("NBTBase")).invoke(localNBTTagList, localNBTTagCompound);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
